 ...
 * @author visnei
 */
public class RStringTableModel extends AbstractTableModel implements RColumnIndexModel{
    ...
    public RStringTableModel(REXPString data) throws REXPMismatchException {
        int[] dim = data.dim();
        if (dim == null) {
            nrow = data.length();
            ncol = 1;
