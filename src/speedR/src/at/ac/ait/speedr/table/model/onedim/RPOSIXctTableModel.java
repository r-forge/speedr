 ...
 * @author visnei
 */
public class RPOSIXctTableModel extends RAbstractTableModel{
    ...
    public RPOSIXctTableModel(REXPDouble data) throws REXPMismatchException {
        int[] dim = data.dim();
        if (dim == null) {
            nrow = data.length();
            ncol = 1;
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        if (REXPDouble.isNA(data[rowIndex])) {
            ...
            return new RPOSIXct((long)data[rowIndex]);
        }
    }
